...
//[CustomEditor(typeof(StatControler), true)]
//public class StatControlerEditor : Editor
//{
...
//    private StatControler targetChar;
...
//    {
//        targetChar = (StatControler)target;

//        reordList = new ReorderableList(serializedObject, serializedObject.FindProperty("Stats"), true, true, true, true);
...
//        SerializedProperty actionTypeParentProp = iteratorProp.FindPropertyRelative("statType");
...
//        List<Type> showTypes = GetNonAbstractTypesSubclassOf<CharacterStat>();
...
//            for (int j = 0; j < reordList.serializedProperty.arraySize; j++)
//            {

//                if (type == targetChar.stats[j].GetType())
//                {
//                    exists = true;
//                    break;
//                }
...
//            string statName = showTypes[i].Name;
//            InsertSpaceBeforeCaps(ref statName);

//            menu.AddItem(new GUIContent(statName), false, OnAddItemFromDropdown, (object)type);
//        }
...
//        //lastProp.managedReferenceValue = Activator.CreateInstance(statType);

//        targetChar.AddStat((CharacterStat)Activator.CreateInstance(statType));

//        //serializedObject.ApplyModifiedProperties();

//        targetChar.OnInsertion();
//    }
